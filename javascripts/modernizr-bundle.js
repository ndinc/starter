/*!
 * modernizr v3.3.1
 * Build http://modernizr.com/download?-adownload-animation-apng-audio-audioloop-audiopreload-batteryapi-bloburls-canvas-canvasblending-canvastext-canvaswinding-capture-classlist-contains-cookies-createelementattrs_createelement_attrs-cssall-customevent-datalistelem-dataset-datauri-dataview-details-devicemotion_deviceorientation-directory-documentfragment-emoji-es5-es5array-es5date-es5function-es5object-es5string-es5syntax-es5undefined-es6array-es6collections-es6math-es6number-es6object-es6string-eventlistener-exiforientation-fileinput-filereader-filesystem-flash-formattribute-formvalidation-framed-fullscreen-gamepads-generators-geolocation-hashchange-hidden-hiddenscroll-history-htmlimports-ie8compat-indexeddb-indexeddbblob-inlinesvg-input-inputformaction-inputformenctype-inputformmethod-inputformtarget-jpeg2000-jpeg2000-jpegxr-json-localizednumber-localstorage-lowbattery-microdata-mutationobserver-notification-oninput-outputelem-performance-picture-placeholder-progressbar_meter-promises-queryselector-requestanimationframe-requestautocomplete-ruby-sandbox-scriptasync-scriptdefer-seamless-search-sessionstorage-sizes-smil-speechrecognition-speechsynthesis-srcdoc-srcset-strictmode-stylescoped-svg-svgasimg-svgclippaths-svgfilters-svgforeignobject-template-templatestrings-textareamaxlength-texttrackapi_track-time-todataurljpeg_todataurlpng_todataurlwebp-touchevents-unicode-unicoderange-unknownelements-urlparser-userdata-vibrate-video-videoautoplay-videoloop-videopreload-webaudio-webgl-webglextensions-webintents-webp-webpalpha-webpanimation-webplossless_webp_lossless-websockets-websocketsbinary-websqldatabase-xdomainrequest-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
