...
module.exports = function(env, extra) {
  ...
  var publicPath = extra ? extra && extra.publicPath : path.join(config.tasks.js.dest, '/');
  var manifestPath = path.join(config.tasks.js.dest, '/');
  ...
  if(env === 'production') {
    webpackConfig.plugins.push(
      new webpackManifest(manifestPath, config.root.dest),
